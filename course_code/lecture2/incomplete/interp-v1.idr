...
------
  ...
  interp env (Var i)     = ?varcase
  interp env (Val x)     = ?valcase
  interp env (Lam sc)    = ?lamcase 
  interp env (App f s)   = ?appcase
  interp env (Op op x y) = ?opcase
  interp env (If x t e)  = ?ifcase
